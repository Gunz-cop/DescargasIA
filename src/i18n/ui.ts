...
export const ui = {
  es: {
    ...
    'lang.soon': 'próximamente',
     ...
     // --- Guías ---
     'guides.indexTitle': 'Guías de IA',
     'guides.indexDescription': 'Tutoriales paso a paso para descargar, instalar y usar herramientas de IA de forma segura y oficial.',
     'guides.noGuidesFound': 'Aún no hay guías disponibles en este idioma.',
  ...
  sv: {
    ...
    'lang.soon': 'kommer snart',
     ...
     // --- Guides ---
     'guides.indexTitle': 'AI-guider',
     'guides.indexDescription': 'Steg-för-steg guider för att ladda ner, installera och använda AI-verktyg på ett säkert och officiellt sätt.',
     'guides.noGuidesFound': 'Det finns för närvarande inga guider tillgängliga på detta språk.',
  ...
  it: {
    ...
    'lang.soon': 'prossimamente',
     ...
     // --- Guides ---
     'guides.indexTitle': 'Guide sull\'IA',
     'guides.indexDescription': 'Tutoriali passo passo per scaricare, installare e utilizzare strumenti IA in modo sicuro e ufficiale.',
     'guides.noGuidesFound': 'Non ci sono ancora guide disponibili in questa lingua.',
