...
| 2026-08-24 | F8 | El catálogo interactivo se sirve como asset estático bajo demanda; la tabla server-rendered conserva el camino sin JavaScript | El catálogo completo es demasiado pesado para el bundle inicial, pero F8 exige que la tabla siga siendo navegable sin JavaScript |
